		...
		<section class="text-center has-success">
			<form class="form-signin" action="" method="POST" enctype="multipart/form-data">
				...
				<div class="custom-file">
					...
					<label class="custom-file-label" for="inputGroupFile01" value="$value"><?php if(empty($_FILES)){echo "Seleccionar imagen";}else{echo $_FILES["avatar"]["name"];}?></label>
				</div>
